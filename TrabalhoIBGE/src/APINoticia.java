    ...
    public List<Noticia> buscarNoticias(String termoBusca, LocalDate dataInicial, LocalDate dataFinal) {
        ...
        if (termoBusca != null && !termoBusca.trim().isEmpty()) {
            try {
                ...
                System.err.println("Erro ao codificar termo de busca: " + e.getMessage());
                return noticias;
            }
        }
        ...
        System.out.println("Buscando na API: " + urlCompleta);
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                System.err.println("Erro ao conectar à API do IBGE. Status: " + response.statusCode());
